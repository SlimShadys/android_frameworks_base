...
public class GlobalActionsDialog implements DialogInterface.OnDismissListener,
    ...
    private final class RestartAction extends SinglePressAction implements LongPressAction {
        ...
        @Override
        public void onPress() {
            if (!mRebootMenu && showRebootSubmenu() && advancedRebootEnabled(mContext)) {
                mRebootMenu = true;
        ...
        private void doShowAlert() {
            ...
            b.setNeutralButton(com.android.systemui.R.string.global_action_settings, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    globalActionSettings.setClassName("com.android.settings", "com.android.settings.Settings$HardwareKeys");
